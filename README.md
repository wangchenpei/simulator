...
5. **划转**（相对基准路径 + 跨年结转）：
   - 维护 **基准主账户**：自期初主账户起，每年按平滑阈值复利增长。
   - 资产收益后，若实际主账户 **低于** 基准：从平滑池回补 `min(池余额, 缺口×填补比例 + 待补主账户)`，不足记入 **待补主账户**。
   - 若实际主账户 **高于** 基准：超出部分先冲减 **待补主账户**，剩余才划入平滑池（主账户仍低于多年累计基准时，即使当年收益率很高也不划入平滑池）。
